<?php
    if(isset($_POST['marks'])){
        ...
        if($subject1 == "Design and Analysis of Algorithm"){
            $sql="UPDATE `multiusercontrol`.`fourthsemcst`SET `algo`='$marks' WHERE enrollment='$enrollment'";
        }
        else if($subject1 == "Programming Paradigms"){
            $sql="UPDATE `multiusercontrol`.`fourthsemcst`SET `pp`='$marks' WHERE enrollment='$enrollment'";
        }
        else if($subject1 == "Theory of Computation"){
            $sql="UPDATE `multiusercontrol`.`fourthsemcst`SET `toc`='$marks' WHERE enrollment='$enrollment'";
        }
        else if($subject1 == "Computer Architecture and Organization - I"){
            $sql="UPDATE `multiusercontrol`.`fourthsemcst`SET `at1`='$marks' WHERE enrollment='$enrollment'";
        }
        else if($subject1 == "Introduction to Data Science"){
            $sql="UPDATE `multiusercontrol`.`fourthsemcst`SET `ds`='$marks' WHERE enrollment='$enrollment'";
        }
        else{
            echo "Error.";
            exit;
...
<body>
    ...
    ?>
    <h4>&nbsp;&nbsp;To Enter <?php echo $subject1 ?> Lab marks <a <?php echo " href='student_marks_lab_4th_CST.php?ugSubject=$subject2'" ?>>Click Here</a> </h4>
            <div class="divTable">
            <table>
                <tr>
                    <th>Name</th>
                ...
                ?>
                    ...
                    <td class="enterMarks"> 
                    <form action="student_marks_4th_CST.php?ugSubject=<?php echo $subject1 ?>" method="post">
