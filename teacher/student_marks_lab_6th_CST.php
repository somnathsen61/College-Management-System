<?php
    if(isset($_POST['marks'])){
        ...
        if($subject1 == "Operating Systems Lab"){
            $sql="UPDATE `multiusercontrol`.`sixthsemcst`SET `osLab`='$marks' WHERE enrollment='$enrollment'";
        }
        else if($subject1 == "Data Communication and Computer Network Lab"){
            $sql="UPDATE `multiusercontrol`.`sixthsemcst`SET `cnLab`='$marks' WHERE enrollment='$enrollment'";
        }
        else if($subject1 == "Software Engineering Lab"){
            $sql="UPDATE `multiusercontrol`.`sixthsemcst`SET `sweLab`='$marks' WHERE enrollment='$enrollment'";
        }
        else{
            echo "Error.";
            exit;
    ...
    ?>  
            ...
            <table>
                ...
                ?>
                    ...
                    <td class="enterMarks"> 
                    <form action="student_marks_lab_6th_CST.php?ugSubject=<?php echo $subject1 ?>" method="post">
